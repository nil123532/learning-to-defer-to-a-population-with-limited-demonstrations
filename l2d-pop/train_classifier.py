...
from lib.datasets import load_cifar, load_ham10000, load_chaoyang , load_gtsrb , load_fashion_mnist
...
def main(config):
    ...
    #NR - Incorporating Vision Transformer for chaoyang dataset
    elif config["dataset"] == 'chaoyang':
        config['n_classes'] = 4
        config['epochs'] = 200
        config['lr'] = 0.1
        train_data, val_data, test_data = load_chaoyang() 
        resnet_base = models.vit_l_16(weights=models.ViT_L_16_Weights) 
        resnet_base.heads = nn.Identity()
        n_features = resnet_base.hidden_dim
    ...
    #NR - GTSRB dataset
        ...
        resnet_base =resnet20(norm_type='batchnorm')
        n_features = resnet_base.n_features
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", choices=["cifar10", "cifar20_100", "ham10000","chaoyang","gtsrb","fashion"], default="cifar10")
