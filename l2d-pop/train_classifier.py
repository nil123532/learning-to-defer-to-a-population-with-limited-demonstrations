...
from lib.datasets import load_cifar, load_fashion_mnist , load_gtsrb
...
def main(config):
    ...
    #NR - Incorporating Vision Transformer for chaoyang dataset - Changed to wideresnet
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", choices=["cifar10", "cifar20_100", "ham10000","chaoyang","fashion","gtsrb"], default="cifar10")
